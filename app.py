...
if __name__ == '__main__':
    print('Welcome to Scanpy!')
    username = input('Type Upwork username: ')
    password = input('Type Upwork password: ')
    secret_key = input('Type Upwork secret key: ').replace(' ', '')
    run(username, password, secret_key)
